...
\begin{align*}
	...
	L(r, \dot{\rho}, \phi, \dot{\phi}, z, \dot{z}) &= \frac12 m (\dot{\rho}^2 + \rho^2 \dot{\phi}^2 + \dot{z}^2) + \frac{\gamma}{r}
...
\begin{align*}
	...
	\dd{t} \ffpartial{L}{\dot{r}} &= m \ddot{\rho} && \\
	\ffpartial{L}{\rho} &= m \rho \dot{\phi}^2 - \frac{\gamma}{\rho^2} &
	\Rightarrow m\ddot{r} - m \rho \dot{\phi}^2 + \frac{\gamma}{\rho^2} &\overset!= 0
\end{align*}
WARNUNG: ab hier macht die aufgabe wenig Sinn. Ab hier sind dies die Lösungen die noch mit der Verwirrung zwischen $r$ und $\rho$
\paragraph{e)}
