...
Einige Phänomene: Rutherford: Elektronen-Wolke ($\SI{1}{\angstrom}$) um Atomkern ($\SI{1}{\femto\meter}$).
...
Statt eines kontinuierlich ansteigenden Stromes werden starke Abfälle beobachtet (nach Schritten von jeweils $\SI{4.9}{\electronvolt}$). Die Elektronen können die Gegenspannung nicht mehr überwinden, da sie Energie an die Hg-Atome abgeben. \conseq Diskrete Energien von $n \cdot \SI{4.9}{\electronvolt}$. Licht der entsprechenden Wellenlänge wird nachgewiesen.

\subsection{Wellennatur der Teilchen}
Beugungsexperimente (Davisson und Germer) von Elektron an Kristallen. \conseq \textbf{Interferenz} von Elektronen-Wellen(?). Wie bei Röntgenstrahlen. Man sieht einen Gangunterschied und damit eine Interferenz (vgl. Röntgen).\\
...
\begin{bemerkung*}
	...
	\conseq Doppelspaltexperiment, für Teilchen Elektron
	\begin{itemize}
	...
	\conseq z.B. mit $\Psi_{1,2}(\vec{r}, t) = $ Wellenfunktion für Elektron durch $S_{1, 2}$\\
