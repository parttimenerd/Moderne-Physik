...
%\footnote{Wir setzen also $b_i = a_i = f_i \circ \vec{r}_i$, schreiben $f_i$ also in Abhängigkeit von $\vec{q}$ statt $\vec{r}$? Wieso dann im hinteren Teil ein $b_i$? Ich finde es verwirrend, woher auf einmal $a_i$ und $b_i$ herkommen.}
\[
