...
Es gibt $j = 3N - (\bar{p} - p)$ generalisierte Koordinaten (bei $\bar{p} - p$ holonomen Zwangsbedingungen). Die konkreten Koordinaten hängen diesen ab: $\vec{r}_i = \vec{r}_i(\vardots{q}{j}, t)$. Wie bereits erwähnt, sind die $q_j$ aber nicht alle unabhängig voneinander.
