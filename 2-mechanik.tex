...
\begin{itemize}
	...
	$ \sum_{m = 1}^{3N} f_{im} \d x_m + f_{it} \d t = 0$\footnote{Wobei $f_{im} := \ffpartial{f_i}{x_m}$ und $f_{it} := \ffpartial{f_i}{t}$.}\footnote{Kurz: $\d f = 0$, wobei $\d f$ das totale Differential ist.}
\end{itemize}
